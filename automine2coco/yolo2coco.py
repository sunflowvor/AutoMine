...
coco_format_save_path='./label/'                      #要生成的标准coco格式标签所在文件夹
yolo_format_classes_path='./automine.names'     #类别文件，一行一个类
yolo_format_annotation_path='./labels2coco/'        #yolo格式标签所在文件夹
img_pathDir='/home/ivan/Desktop/3Dbox-2/split_1/test/image/'                        #图片所在文件夹
